...
puts arbol_b_1.fold(0) { |x,acc| x.valor + acc }
# 55

a = arbol_b_1.recoger(lambda { |x| x.valor.even? })
for x in a
    print x.valor
    print ' '
end
...
a = arbol_r_1.recoger(block)
for x in a
    print x.valor
    print ' '
end
puts ''# [arbol_r_1, arbol_r_lana, arbol_r_lima, arbol_r_lamina, arbol_r_ala, arbol_r_mani]